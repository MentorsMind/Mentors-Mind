        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white w-full">
          ...
          <div className="space-y-8">
            <div className="animate-slide-in-left" style={{ animationDelay: '100ms' }}>
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Connect with world-class mentors and unlock your potential in Tech, Business, and Medicine.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {[
                { icon: Check, text: <><AnimatedCounter end={2000} suffix="+" /> Active Learners</> },
          ...
          <div className="space-y-4">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 animate-slide-in-left opacity-0" style={{ animationDelay: '650ms' }}>
              <p className="text-lg italic mb-2">"The best investment you can make is in yourself."</p>
        ...
        <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
          <div className="w-full max-w-md">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              {/* Name Input */}
              <div className={`group animate-fade-in-up opacity-0 ${errors.name ? 'animate-shake' : ''}`} style={{ animationDelay: '200ms' }}>
              ...
              {/* Email Input */}
              <div className={`group animate-fade-in-up opacity-0 ${errors.email ? 'animate-shake' : ''}`} style={{ animationDelay: '300ms' }}>
                <label className="block text-gray-700 dark:text-gray-300 text-sm font-semibold mb-2">
                  Email Address
                </label>
              ...
              {/* Password Input */}
              <div className={`group animate-fade-in-up opacity-0 ${errors.password ? 'animate-shake' : ''}`} style={{ animationDelay: '400ms' }}>
                <label className="block text-gray-700 dark:text-gray-300 text-sm font-semibold mb-2">
                  Password
                </label>
                <div className="relative">
            ...
            <div className="mt-8 text-center space-y-4">
              <p className="text-xs text-gray-500 max-w-sm mx-auto">
                By signing up, you agree to our <a href="#" className="text-emerald-600 hover:text-emerald-700 font-medium">Terms</a> & <a href="#" className="text-emerald-600 hover:text-emerald-700 font-medium">Privacy Policy</a>.
              </p>
