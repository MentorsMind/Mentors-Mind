          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Continue your learning journey with personalized mentorship from
                industry experts.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  text: (
                    <>
                      <AnimatedCounter end={2000} suffix="+" /> Active Community
                    </>
                  ),
                },
          ...
          <div className="space-y-4">
            ...
            >
              <p className="text-lg italic mb-2">
                "MentorMinds transformed my career path completely!"
              </p>
