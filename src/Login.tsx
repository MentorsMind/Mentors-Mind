...
import { ArrowLeft, ArrowRight, Eye, EyeOff, Shield, Users, TrendingUp, Check } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex bg-white dark:bg-[#050B0A] overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-600 via-emerald-500 to-emerald-600 animate-gradient"></div>
        
        {/* Floating Orbs */}
        <div className="absolute top-20 right-20 w-72 h-72 bg-white/10 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-20 left-20 w-96 h-96 bg-emerald-400/20 rounded-full blur-3xl animate-float-slow"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-blue-500/10 rounded-full blur-2xl animate-float-slower"></div>
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white w-full">
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              <img src={logo} alt="Bentech" className="w-12 h-12 object-contain animate-logo-pulse" />
          ...
          <div className="space-y-8">
            <div className="animate-slide-in-left" style={{ animationDelay: '100ms' }}>
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Continue your learning journey with personalized mentorship from industry experts.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {[
                { icon: Users, text: <><AnimatedCounter end={2000} suffix="+" /> Active Community</> },
          ...
          {/* Footer Testimonial */}
          <div className="space-y-4">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 animate-slide-in-left opacity-0" style={{ animationDelay: '650ms' }}>
              <p className="text-lg italic mb-2">"MentorMinds transformed my career path completely!"</p>
              <p className="text-sm text-white/70">— Sarah Chen, Software Engineer</p>
            </div>
            
            {/* Social Proof */}
            <div className="animate-slide-in-left opacity-0" style={{ animationDelay: '800ms' }}>
              <SocialProof />
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col">
        ...
        <header className="lg:hidden fixed top-0 w-full flex items-center justify-between p-4 z-10 bg-white/80 dark:bg-[#050B0A]/80 backdrop-blur-md border-b border-gray-200 dark:border-white/5">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-gray-900 dark:text-white">MentorMinds</span>
          </div>
        ...
        <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
          <div className="w-full max-w-md">
            ...
            {/* Form Header */}
            <div className="mb-8 mt-20 lg:mt-0 animate-fade-in-up opacity-0" style={{ animationDelay: '100ms' }}>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              {error && (
                  <div className="p-4 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 text-sm rounded-xl border-2 border-red-100 dark:border-red-800 animate-shake">
                      {error}
                  </div>
              )}
              ...
              <div className="group animate-fade-in-up opacity-0" style={{ animationDelay: '300ms' }}>
               ...
               {/* Forgot Password */}
               <div className="flex justify-end animate-fade-in-up opacity-0" style={{ animationDelay: '400ms' }}>
              ...
              <button 
                type="submit" 
                disabled={loading}
                className="relative w-full bg-emerald-600 hover:bg-emerald-700 active:scale-[0.98] text-white font-bold text-lg h-14 rounded-xl transition-all duration-200 shadow-lg shadow-emerald-600/30 hover:shadow-xl hover:shadow-emerald-600/40 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed mt-6 animate-fade-in-up opacity-0 ripple-effect btn-shimmer-hover overflow-hidden"
